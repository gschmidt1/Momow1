...
CREATE TABLE Service_Details (
    ...
    FOREIGN KEY (service_headerid) REFERENCES SERVICE_HEADER(id),
...
--Inser Users
INSERT INTO users VALLUE(1,1,'gschmidt','javauser', 
                          'gschmidt', current timestamp, 'gschmidt', current timestamp);

--Insert Members
INSERT INTO members VALLUE(1,1, current date, 'Glenn', 'Schmidt', '4813 Gerona Drive', 'Austin',
                            '78759', '512-947-2264', 'Y', 'glenn.schmidt@g.austincc.edu', 
                              'gschmidt', current timestamp, 'gschmidt', current timestamp);

--Insert Service Header
INSERT INTO service_header VALUES(1, 1,  null, 'This are test instructions', 
                            '2015-11-02', null, null, null,
                            'gschmidt', current timestamp, 'gschmidt', current timestamp),

--Insert Service Details
INSERT INTO service_details VALUES(1, 1, 'mow', null, 
                            'gschmidt', current timestamp, 'gschmidt', current timestamp),
                            (2, 1, 'edge', null, 
                            'gschmidt', current timestamp, 'gschmidt', current timestamp);
                            (3, 1, 'rake', null, 
...
--Insert Services
INSERT INTO services VALUES(1, 'mow', 'Lawn Mowed', 1, null,
                                    'gschmidt', current timestamp, 'gschmidt', current timestamp), 
                           (2, 'edge', 'Edge Lawn', 2, null,
                                    'gschmidt', current timestamp, 'gschmidt', current timestamp), 
                           (3, 'rake', 'Rake Leaves', 3, null,
                                    'gschmidt', current timestamp, 'gschmidt', current timestamp), 

--Insert Company
INSERT INTO company VALUES(1, 'Mowmow Services', '123 1st Street', 'Austin', '78728', 
